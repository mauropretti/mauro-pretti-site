...
export const metadata: Metadata = {
  title: 'Proyectos',
  description:
    'Proyectos fotográficos autorales de Mauro Pretti. Fotografía artística, series expositivas y piezas visuales desde Buenos Aires.',
  alternates: {
    canonical: 'https://mauropretti.com/projects',
  },
  openGraph: {
    title: 'Proyectos | Mauro Pretti',
    description:
      'Proyectos fotográficos autorales de Mauro Pretti. Fotografía artística, series expositivas y piezas visuales desde Buenos Aires.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Proyectos fotográficos de Mauro Pretti',
      },
    ],
  },
  twitter: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-24">
          {projects
            ...
            .map((project: any) => {
              ...
              return (
                <GsapReveal key={project._id} y={80} duration={1.8}>
                  <Link
                  ...
                  >
                    ...
                    <div className="relative w-full aspect-[4/3] overflow-hidden">
                      <img
                        src={urlFor(image).width(1200).quality(82).url()}
                        alt={`${project.title} – proyecto fotográfico de Mauro Pretti`}
                        className="
                          absolute inset-0
                          w-full h-full
                          object-cover
